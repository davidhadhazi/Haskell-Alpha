...
integrate (BINIX (e1, MUL, e2))
 | isMultipleOf (simplifying (derivate e2)) (simplifying e1) = BINIX (BINIX (SIMPLE 1, DIV, SIMPLE (difference (simplifying (derivate e2)) e1)), MUL, BINIX (BINIX (e2, RAI, SIMPLE 2), DIV, SIMPLE 2))
 | isMultipleOf (simplifying (derivate e1)) (simplifying e2) = BINIX (BINIX (SIMPLE 1, DIV, SIMPLE (difference (simplifying (derivate e1)) e2)), MUL, BINIX (BINIX (e1, RAI, SIMPLE 2), DIV, SIMPLE 2))
